...
if choice4 == 2:
    ...
    slow_print("FBI Agent:     You are an astronomer and have also shown interest in foreign languages...")
    slow_print("               Am I correct about that?")
...
if choicefunc == 2:
    ...
    runner.run()
    slow_print("~ That looks really similar to what I remember it should look like! ~")
