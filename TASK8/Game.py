...
TEXT_DELAY = 1.2  # adjust speed here
...
# STORY START
slow_print("You are sitting on the couch in your living room when suddenly somewhere in the distance you hear..")
...
if choice1 == 1:  # YOU OPEN THE DOOR
    ...
    # ONLY CHANGE HERE (secret option applied)
    choice2 = get_choice_secret("Type 1 for yes, 2 for no: ", [1, 2], 3)

    if choice2 == 1:
        slow_print("\nYou:           I accept.")
        slow_print("FBI Agent:     Very well then... Come with me.")
        slow_print("You are taken to a car and before you know it you've been driving for 2 hours.")
        ...
        slow_print("You are forcefully taken to a car and before you know it you've been driving for 2 hours.")
        ...
        slow_print("               We need an expert in the fields of linguistics and outer space and heard that you might know a thing or two about that.")
    ...
    slow_print("She says something through her walkietalkie and through the crack in the open window you can just hear what she says.")
    slow_print("FBI Agent:     Agent 42 here...")
    ...
    slow_print("\nAfter hearing the conversation between the FBI Agent and their coworker you start to doubt your decision to open the door.")
    ...
    if choice3 == 1:
        ...
        slow_print("Luckily the FBI agent is still outside her car, focussed on her phone.")
        ...
        slow_print("FBI Agent:     I unfortunately can't share much, but you are correct.")
        ...
        slow_print("You decide that it's probably the best option to stay inside and let the FBI find a new 'expert'.")
...
''' CHOSE NOT TO OPEN DOOR AT ALL '''
TEXT_DELAY = 1.2 # Change time
...
if choice1 == 2:
    ...
    slow_print("On the screen you see footage from New York, Paris, Athens, Tokyo and about 10 other mayor cities in the world.")
...
TEXT_DELAY= 1.2 # Change speed

''' WILLING PATH'''
''' WITHOUT KNOWLEDGE'''
if choice1==1 and choice2==1:
    slow_print("After the long journey you finally arrive at the destination")
    ...
    slow_print("Everyone is rather nice and chill, but there is still an eery atmosphere.")
...
if choice1==1 and choice2==2:
    ...
    slow_print("Your mind goes blank as the security searches you and asks for your identification and any other personal belongings")
    slow_print("Guard:         Hey, answer our questions clearly and quickly!")
    slow_print("There is an eery and dark atmosphere around that makes you even more stressed.")
...
if choice4 == 1:
    ...
    slow_print("\n               What could I possibly do for you that you can't get from anyone else?")

    slow_print("FBI Agent:     You are an astronomer and have also shown interest in foreign and dead languages...")
    ...
    slow_print("               We need both of those fields, astronomy and linguistics, to decipher what the alien creatures are trying to tell us.")
...
if choice5 == 1:
    ...
    slow_print("There are a few things about the creatures that caught your attention.")
    slow_print("Firstly there are symbols on the side of the space ship")
    slow_print(" /-/ |_| |3 |3 |_ |≡ ")
    slow_print("The spaceship they arrived in contained data that you very clearly recognise.")
...
if choice6 == 1:
    ...
    slow_print("The tables found in the data have the following names:")
    slow_print("Mass, Frequency, redshift, Volume, Viscosity, magnitude, Intensity, Force, Length")
    ...
    slow_print("There are a few constants you know of.")
    ...
    slow_print("Which of these constants are you most likely to find?")
    while True:
    ...
    slow_print("Now that you have chosen a constant,")
...
while True:
    ...
    if (
        ...
        print("You have selected the Hubble constant, reshift, and magnitude.")
        choicelast = 1
        break
...
if choicelast == 2:
    slow_print("With your selected constants you try to calculate a constant.")
    ...
    slow_print("The evening news is on in many homes around the world")
    slow_print("Same as always... Except for the fact that its not")
    slow_print("On the screen footage from New York, Paris, Athens, Tokyo and about 10 other mayor cities in the world is shown.")
    slow_print("All cities look like they always do, except there are no people.")
    slow_print("It is all empty.")
    slow_print("\nThe screen switches to a reporter who seems to be interviewing an FBI agent just outside of New York")
...
if choicelast == 1:
    ...
    if choicefunc == 1 or choicefunc == 3:
        slow_print("You fill in the equation and try to find a constant")
        slow_print("After days of work you have still not gotten any value which lead to a clear deciphering of the alien language.")
        slow_print("After two weeks you still have not gotten any results.")
        slow_print("That is when the alarm at the secret facility goes off")
        slow_print(" * ALERT * ")
...
if choicefunc == 2:
    ...
    res = SDSS.query_sql(query, data_release=17, timeout=60, format='csv')

    if res is None:
        print("SDSS returned no data (query failed or empty result).")
        exit()

    # Extract data
    z = np.array(res['z'])
    m = np.array(res['modelMag_r'])

    slow_print("You calculate the velocity using the chosen equation")

    c = 3e5
    v = c * z

    # distance from distance modulus
    M = -21  # rough L* galaxy value
    ...
    slow_print("Finally")
    slow_print(f"After two days of work you have found the value: {H0:.2f}")
    slow_print("You immediately recognise it as a value close to Hubble's constant.")
    ...
    slow_print("~ Wow, how did I not think of that! ~")
    ...
    slow_print("You grab the written down alien language")
    ...
    input("Press Enter to continue once you've decoded the language...")
    slow_print("~ They want candy... ~")
    slow_print("~ Thats it... ~")
