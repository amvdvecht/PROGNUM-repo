...
if choice1 == 1:  # YOU OPEN THE DOOR
    ...
    slow_print("\nAfter hearing the conversation between the FBI Agent and their coworker")
    slow_print("you start to doubt your decision to open the door.")
    ...
    if choice3 == 1:
        ...
        if choice2 == 1:
            ...
            slow_print("FBI Agent:     Then I'm afraid I'll have to take you with or without your permission...")
            slow_print("You are forcefully taken to a car and before you know it you've been driving for 2 hours.")
            slow_print("~ I should've just stayed inside... ~")
            slow_print("~ Why did I open the door... ~")
...
if choice1 == 2:
    ...
    slow_print("Same as always...")
    slow_print("Except for the fact that its not.")
